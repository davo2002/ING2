                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                        <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <a href="tech" class="">
                                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Tech Solutions</h3>
                                </a>
                                <h3>Sign In</h3>
                            </div>
                            <form class="user" action="<?php echo base_url().'login/veri'?>" method="post">
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="ifloatingInputnputEmail" type="correo" name="correo" placeholder="name@example.com" />
                                ...
                                <p class="text-center mb-0">Don't have an Account? <a href="seginup">Sign Up</a></p>
                        </from>
                    </div>
